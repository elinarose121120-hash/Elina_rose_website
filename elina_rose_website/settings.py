...
INSTALLED_APPS = [
    ...
    'website.apps.WebsiteConfig',  # Use app config to load compatibility fixes
]
...
ROOT_URLCONF = 'elina_rose_website.urls'
...
WSGI_APPLICATION = 'elina_rose_website.wsgi.application'
